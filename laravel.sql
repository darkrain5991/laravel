...
CREATE TABLE `chat` (
  ...
  `nick` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
...
INSERT INTO `chat` (`words`, `nick`) VALUES
('有一個活動', '紅茶'),
('哈哈哈', 'smiling'),
('哈哈哈', 'darkrain5991'),
('哈哈哈', '紅茶'),
...
(1, '123', 'dark', '$2y$10$VLK7omPGJ0NtOzdUJNAQLON6kN81nm2z/cmh.DhIBN3V2NIwHtKUC', 'test@gmail.com', '先生', '12345678', '710', '台南市', '永康區', '123');
